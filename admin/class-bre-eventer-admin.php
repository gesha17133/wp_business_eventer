...
class Bre_Eventer_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * class.
		 */
		wp_enqueue_style('select2@4','https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/css/select2.min.css');
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script('select2@4',"https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/js/select2.min.js",array('jquery'));
		...
		foreach($posts as $post){
			array_push($post_list, $post->post_title);
		}
		...
		wp_localize_script($this->plugin_name,'select_2', $params);
	}
